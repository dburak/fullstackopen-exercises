...
describe('favorite blog', () => {
  ...
  test('finds out which blog has the most likes', () => {
    const result = listHelper.findMostLiked(blogs);
...
describe('most blogs', () => {
  ...
  test('finds the author who has the largest amount of blogs.', () => {
...
describe('most likes', () => {
  ...
  test('finds the author who has the largest amount of likes.', () => {
